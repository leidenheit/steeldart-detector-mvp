...
public final class Pagination {
    ...
    private static final List<PageRelation> pageRelations = List.of(
            ...
            new PageRelation(MASK_SEGMENTS, MASK_SEGMENT_FINE_ADJUSTMENT, MASK_SEGMENT_ADJUSTMENT),
            new PageRelation(MASK_SEGMENT_FINE_ADJUSTMENT, DARTBOARD_SUMMARY, MASK_SEGMENTS),
            new PageRelation(DARTBOARD_SUMMARY, null, MASK_SEGMENT_FINE_ADJUSTMENT),
